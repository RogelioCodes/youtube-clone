...
const processedVideoBucketName = "bolo-yt-processed-videos";
 ...
 * @returns A promise that resolves when the vieo has been converted.
 */
...
/**
 * @param fileName - The name of the file to download from the {@link rawVideoBucketName} into the {@link localRawVideoPath} folder.
...
/**
 * Ensures a directory exists, creating it if it does not exist.
